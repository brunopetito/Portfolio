...
export default function Projetos(){
  ...
  return(
    <div > 
      <div className={`flex justify-center fit-content mt-20 items-center gap-1 ${scrollPosition >10? 'invisible ':'blink-2'}`}>
      ...
      <div className={`text-[#2F2F2F]  ${scrollPosition < 100 ?'invisible': 'fade-in'}`}>
        ...
        <section className="flex justify-center content-center align-center gap-2 ">
          <span className="text-2xl font-display ">Projetos</span>
            <ProjectorScreenChart size={28} color="#2F2F2F" className="self-center "/>
       
        </section>

        <section className="mb-12 font-content">
          <CardProjeto
          url={projeto2Url} 
          urlLogo={diaryLogo} 
          urlVercel={'https://di4ry.vercel.app/'}
          description={ 'O  Di4ry foi criado com objetivo de consolidar meus estudos em UI/UX Design e React. Com ele os gestores escolares e professores podem ter total acesso e controle sobre o dia-dia escolar 24hs por dia.'}
          ...
          <CardProjeto
            ...
            description="Projeto simples inspirado em layouts de jogo da velha da internet porém responsivo."
            tecnologies={'React e TailwindCSS'}
            url={velhaFoto}
          />  
          ...
          >
            <div className="flex gap-2 align-middle justify-center mt-6 bg-[#B6B0FF] w-fit m-auto p-3 rounded">
