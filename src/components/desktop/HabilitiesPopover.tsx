...
export default function HabilitiesPopover({
  url,
  alt,
  popoverContent,
  tec
      ...
      <Popover.Root>
        ...
        <Popover.Content className="w-60 h-fit bg-zinc-50 border rounded z-10">
          ...
          <div className="p-2 flex flex-col justify-center items-center ">
            <p className="font-bold font-display text-purple-700">{tec}</p>
            <p className="text-xs text-black">{popoverContent}</p>
          </div>
          <Popover.Arrow className=" fill-purple-400 " />
        </Popover.Content>
      </Popover.Root>
    </>
  );
