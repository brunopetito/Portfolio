          ...
          <div className="min-w-[50%]  flex flex-col items-center mt-20">
            <div className="grid grid-cols-3 gap-5">
              ...
              <HabilitiesPopover
                url={next}
                alt="Next.js"
                popoverContent="Next.js é uma estrutura da web de desenvolvimento front-end React de código aberto criada por Vercel que permite funcionalidades como renderização do lado do servidor e geração de sites estáticos para aplicativos da web baseados em React. "
                tec="Next.js"
              />
            </div>
          </div>
